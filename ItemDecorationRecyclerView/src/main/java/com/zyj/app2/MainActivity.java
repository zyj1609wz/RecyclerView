...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private RecyclerView.ItemDecoration itemDecoration3 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemDecoration2 = new DividerItemDecoration2( this ) ;
        itemDecoration3 = new DividerItemDecoration3( this ) ;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.itemDecoration1:
                ...
                recyclerView.addItemDecoration( itemDecoration1 );
                break;
            case R.id.itemDecoration2 :
                removeAllItemDecoration();
                recyclerView.addItemDecoration( itemDecoration2 );
                break;
            case R.id.itemDecoration3 :
                removeAllItemDecoration();
